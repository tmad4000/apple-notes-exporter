...
OUTPUT_FILE="./output/nov21_2025_notes.txt"
...
for i in $(seq 1 $NOTES_TO_CHECK); do
    ...
    # Parse the date (format like "Friday, November 21, 2025 at 12:00:00 AM")
...
if [ $NOTE_COUNT -eq 0 ]; then
    ...
    echo ""
    echo "Successfully exported $NOTE_COUNT note(s) from today to ./output/nov21_2025_notes.txt"
fi